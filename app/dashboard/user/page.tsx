...
export default function UserPage() {
  ...
  useEffect(() => {
    // Redirect to the main dashboard which will show the user view
    ...
    <div className="flex h-full w-full items-center justify-center py-24">
      ...
      >
        <div className="relative">
          <div className="absolute inset-0 rounded-full bg-blue-200 dark:bg-blue-900/30 animate-ping opacity-30"></div>
          <Loader2 className="h-12 w-12 animate-spin text-blue-600 dark:text-blue-400 relative z-10" />
        </div>
        <div className="text-center">
          <p className="text-lg font-medium text-gray-700 dark:text-gray-300">Loading user dashboard...</p>
